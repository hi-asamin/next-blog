...
// import usecases
import { init } from '@/src/usecases/dummy';

// import page model
import { A1 } from '@/src/domain/ui/a-1';
import { MetaProps } from '@/src/components/atoms/meta';

// import components
import { NavbarFooterLayoutTemplate } from '@/src/components/templates/navbar-footer-layout';
import { DummyTemplate } from '@/src/components/templates/dummy';
